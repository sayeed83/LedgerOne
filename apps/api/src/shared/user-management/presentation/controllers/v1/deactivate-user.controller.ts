...
import { deactivateUser } from "../../../business/deactivate-user.service";
...
/** `POST /api/v1/users/:userUuid/deactivate` — 00_BUSINESS_RULES.md Ch.10.5: Active -> Deactivated. */
export function deactivateUserController(deps: UserManagementDependencies) {
