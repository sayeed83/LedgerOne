...
import { activateUser } from "../../../business/activate-user.service";
...
/** `POST /api/v1/users/:userUuid/activate` — 00_BUSINESS_RULES.md Ch.10.5: Invited/Suspended -> Active. */
export function activateUserController(deps: UserManagementDependencies) {
