...
// this task; this is the interim substitute, mirroring Accounting's own
// handle-domain-errors.ts exactly). Anything that is not a DomainError is
// rethrown — with no error-handling middleware registered yet, an
// unexpected/programmer error surfaces as an unhandled rejection rather
// than a graceful 500, which is a known, flagged gap.
import { Request, Response } from "express";
import { DomainError } from "../../business/inventory-errors";
