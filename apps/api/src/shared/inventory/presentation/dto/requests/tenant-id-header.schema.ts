...
// Tenant-context validator for this module's endpoints. Inventory does not
// own Tenant (Organization does) — mirroring Accounting's/User Management's/
...
// measure already used by Accounting/User Management/Authorization, and the
// real mechanism remains undesigned per those files' own comments.
