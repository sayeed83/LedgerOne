...
import { reopenFinancialYear } from "../../../business/reopen-financial-year.service";
...
/** `POST /api/v1/accounting/financial-years/:financialYearUuid/reopen` — 00_BUSINESS_RULES.md Ch.5.5/FY-004: Closed -> Reopened, a heavily audited exception. */
export function reopenFinancialYearController(deps: AccountingDependencies) {
  return handleDomainErrors(async (req: Request, res: Response): Promise<void> => {
    ...
    const financialYear = await reopenFinancialYear(
