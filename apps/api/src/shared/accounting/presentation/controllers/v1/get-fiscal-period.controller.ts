...
import { getFiscalPeriod } from "../../../business/get-fiscal-period.service";
...
/** `GET /api/v1/accounting/fiscal-periods/:fiscalPeriodUuid` — scoped to the `X-Tenant-Id` tenant. */
export function getFiscalPeriodController(deps: AccountingDependencies) {
  return handleDomainErrors(async (req: Request, res: Response): Promise<void> => {
    ...
    const fiscalPeriod = await getFiscalPeriod(
