...
import { softCloseFiscalPeriod } from "../../../business/soft-close-fiscal-period.service";
...
/** `POST /api/v1/accounting/fiscal-periods/:fiscalPeriodUuid/soft-close` — 00_BUSINESS_RULES.md Ch.6.5: Open -> SoftClosed. */
export function softCloseFiscalPeriodController(deps: AccountingDependencies) {
  return handleDomainErrors(async (req: Request, res: Response): Promise<void> => {
    ...
    const fiscalPeriod = await softCloseFiscalPeriod(
