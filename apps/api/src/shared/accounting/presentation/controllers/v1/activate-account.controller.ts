...
import { activateAccount } from "../../../business/activate-account.service";
...
// shape).
/** `POST /api/v1/accounting/accounts/:accountUuid/activate` — 00_BUSINESS_RULES.md Ch.17.5: Draft/Inactive -> Active. */
export function activateAccountController(deps: AccountingDependencies) {
