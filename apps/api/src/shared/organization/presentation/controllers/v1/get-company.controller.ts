...
import { getCompany } from "../../../business/get-company.service";
...
/** `GET /api/v1/organization/companies/:companyUuid` — scoped to the `X-Tenant-Id` tenant. */
export function getCompanyController(deps: OrganizationDependencies) {
