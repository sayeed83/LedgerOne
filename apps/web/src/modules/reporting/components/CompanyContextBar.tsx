...
// Every Financial Report is scoped by `companyUuid` (each report always
// covers one Company's own Chart of Accounts) — mirrors Accounting's own
// CompanyContextBar.tsx exactly, reading/writing the shared
// CurrentCompanyContext (STATE-003).
