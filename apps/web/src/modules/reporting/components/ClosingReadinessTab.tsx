  ...
  return (
    <div>
      ...
      {fiscalPeriodUuid && closingReadinessQuery.isLoading && (
        <Card>
          <CardContent className="pt-6 text-sm text-ink-muted">Checking closing readiness…</CardContent>
        </Card>
      )}
        ...
        <Card>
          <CardContent className="flex flex-col gap-4 pt-6">
            ...
            <dl className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              <div>
                <dt className="text-xs font-medium uppercase tracking-wide text-ink-muted">Trial Balance Balanced</dt>
                <dd className="mt-1 text-sm text-ink">
                  {closingReadinessQuery.data.trialBalanceBalanced ? "Yes" : "No"}
                </dd>
              </div>
              <div>
                <dt className="text-xs font-medium uppercase tracking-wide text-ink-muted">Prior Periods Closed</dt>
                <dd className="mt-1 text-sm text-ink">
