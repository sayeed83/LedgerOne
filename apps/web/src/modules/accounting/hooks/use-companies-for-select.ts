...
// ARCH-004: Accounting never imports from `modules/organization/*` — this
// reads the Organization module's own `services/organization.service.ts`
// (the sole API chokepoint, not a module-internal file), the same pattern
// any module is free to use per ARCH-003.
