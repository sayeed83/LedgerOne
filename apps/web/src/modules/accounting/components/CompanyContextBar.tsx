...
// Every Accounting entity scoped by `companyUuid` (Financial Year, Tax
// Group, Account Group, Chart of Accounts, Journal Entries) shares this one
// bar instead of re-wiring a Company picker per screen — reads/writes the
// shared CurrentCompanyContext (STATE-003).
