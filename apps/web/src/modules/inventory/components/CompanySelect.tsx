...
// 08_FRONTEND_STANDARDS.md Ch.5.3) — mirrors Accounting's own
// CompanySelect.tsx exactly; every Company-scoped Inventory entity reuses
// this instead of re-wiring the Organization lookup per form.
