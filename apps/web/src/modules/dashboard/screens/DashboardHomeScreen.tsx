...
export function DashboardHomeScreen() {
  return (
    <div className="flex flex-col gap-6">
      <div>
        <h1 className="text-2xl font-semibold tracking-tight text-ink light:text-light-ink">Dashboard</h1>
        <p className="mt-1 text-sm text-ink-muted light:text-light-ink-muted">
