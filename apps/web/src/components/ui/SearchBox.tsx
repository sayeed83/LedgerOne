  ...
  return (
    <div className="relative w-full max-w-xs">
      ...
      <input
        ...
        className="w-full rounded-xl border border-surface-border bg-surface-sunken py-2 pl-9 pr-3 text-sm text-ink placeholder:text-ink-faint focus:outline-none focus:ring-2 focus:ring-primary-500/40"
      />
    </div>
  );
}
